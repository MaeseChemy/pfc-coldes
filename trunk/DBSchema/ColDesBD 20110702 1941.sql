...
INSERT INTO `room` (`id`,`roomname`,`roomdescription`,`owner`,`private`,`participationtype`) VALUES 
 (1,'Diseño PFC','Diseño del proyecto de fin de carrera','chemy',1,0),
 (2,'Sala anarquica','Prueba de anarquia','chemy',0,1),
 (3,'Sala de prueba','Prueba','chemy',0,0);
...
CREATE TABLE `roomuserpencil` (
  ...
  CONSTRAINT `FK_pencilIdRoom` FOREIGN KEY (`id_room`) REFERENCES `room` (`id`),
  CONSTRAINT `FK_pencilUsername` FOREIGN KEY (`username`) REFERENCES `user` (`username`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `user` (`username`,`password`,`name`,`surname1`,`surname2`,`email`,`admin`,`designer`,`active`,`sessionid`,`lastlogin`,`lastoperation`) VALUES 
 ('chemy','36483a997c6c7dca97c7f941675256f646074c63','Jose Miguel','Blanco','Garcia','chemy@coldes.es',1,1,1,'ID-ChemySobremesa-55815-1309624931747-1-0','2011-07-02 18:43:45','2011-07-02 18:43:52'),
 ('lucy','474e97d07b83ea9b34d1ec399840354182f3b6c1','Luz Isabel','Pelaez','Baños','lucy@coldes.es',0,1,1,'ID-ChemySobremesa-55815-1309624931747-1-1','2011-07-02 18:44:40','2011-07-02 18:53:37');
